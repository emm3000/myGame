...
- **Resolve** — applying every finished upgrade to the fief, on read, in order: each one accrues to its finish at the levels before it, and the next waiting upgrade starts at that instant.
